...
class MarketPress_Auto_Update {
	...
	public function setup( $plugindata ) {
		...
		// Setting up the license checkup URL
		self::$url_key_check = 'https://marketpress.com/mp-key/' . $parameter_string;
	...
	public function license_key_checkup( $key = '' ) {
		...
		self::$url_key_check = 'https://marketpress.com/mp-key/' . $this->key . '/' . $this->sanitized_plugin_name . '/' . sanitize_title_with_dashes( network_site_url() );
